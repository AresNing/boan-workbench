...
export function modelService() {
 ...
 const mock=http.createServer(async(req,res)=>{
  ...
  requests.push({model:body.model,path:req.url,auth:anthropic?req.headers['x-api-key']:req.headers.authorization,effort:body.reasoning_effort,thinking:body.thinking,outputConfig:body.output_config,tier:body.service_tier,speed:body.speed,beta:req.headers['anthropic-beta']});
